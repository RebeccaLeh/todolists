...
class ExcelOutput(object):
    ...
    def execute(self, parameters, messages):
        ...
        def mainInfo(familyType, familyFullName, startRow):
                ...
                if familyFullName == "Households with At Least One Adult and One Child":
                    #age
        ...
        worksheet_data.merge_range('A79:G79', "YOUTH HOUSEHOLDS", merge_format)
        #column names
        ...
        ##shelter type
        mainInfo(ADCH, 'Households with At Least One Adult and One Child', 0)
        ...
        ##shelter type
        mainInfo(vetNOCH, "Veteran HH without Children", 106)
        ...
        ##shelter type
        shelterType(ythUnacc, ' Unaccompanied Youth Households', 127 )
        #####chronic homelessness status

        ############################################Parenting youth                                                         14
        ##shelter type
        shelterType(PARYth, 'Parenting Youth Households', 152)
        #####chronic homelessness status
